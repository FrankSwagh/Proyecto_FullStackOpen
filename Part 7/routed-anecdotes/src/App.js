...
const CreateNew = (props) => {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} onReset={resetEntries}>
                <div>
                    content
                    <input {...content} />
                </div>
...
const AnecdoteOnly = ({ anecdotes }) => {
    const id = useParams().id
    const anecdote = anecdotes.find((a) => a.id == id)
    return (
        <div>
            <p>
                <b>{anecdote.content}</b> by <b>{anecdote.author}</b>
            </p>
        ...
        <div>
            <Router>
                ...
                <Routes>
                    <Route
                        path="/anecdotes/:id"
                        element={<AnecdoteOnly anecdotes={anecdotes} />}
                    />
                    <Route
                        path="/create"
                        element={
